...
//test
export const SendComment = ({id,tab,productId,commentNumber,info}) => {
    ...
    const submit = async (e) => {
        ...
        // if (auth) {
            ...
            await axios.post(url, data).then((response) => {
                ...
                // console.log(errors);
                setError(errors?.response.data.errors, { type: "focus" }, { shouldFocus: true })
                                        ...
                                        <div className="review-input">
                                            <div className="review-ratings mb-10">
                                                <div className="review-ratings-single d-flex align-items-start">
                                                    <span>کیفیت</span>
                                                    {/* <Rank></Rank> */}
                                                    {/* <RateSubmit  sendQuality={setQuality} quality={quality} type="lg"></RateSubmit> */}
                                                </div>
